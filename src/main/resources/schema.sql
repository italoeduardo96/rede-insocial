...
--   TP_PHONE          varchar(20) NOT NULL,
--   DT_INSERT         timestamp NOT NULL,
--   DT_LAST_UPDATE    timestamp NOT NULL,
--   PRIMARY KEY (CD_SEQ_PHONE));
--
-- ALTER TABLE CORE.TB_MERCHANT ADD CONSTRAINT FKTB_MERCHAN1 FOREIGN KEY (CD_SEQ_ADDRESS) REFERENCES CORE.TB_ADDRESS (CD_SEQ_ADDRESS);
-- ALTER TABLE CORE.TB_EMAIL ADD CONSTRAINT FKTB_MERCHAN2 FOREIGN KEY (CD_SEQ_MERCHANT) REFERENCES CORE.TB_MERCHANT (CD_SEQ_MERCHANT);
-- ALTER TABLE CORE.TB_PHONE ADD CONSTRAINT FKTB_MERCHAN3 FOREIGN KEY (CD_SEQ_MERCHANT) REFERENCES CORE.TB_MERCHANT (CD_SEQ_MERCHANT);
